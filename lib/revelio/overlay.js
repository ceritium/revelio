  ...
  function setupToggles() {
    ...
    if (disableBtn && !disableBtn.hasAttribute('data-revelio-bound')) {
      ...
      disableBtn.addEventListener('click', function() {
        ...
        ['revelioToggleViewOutlines', 'revelioTogglePartialOutlines', 'revelioToggleComponentOutlines', 'revelioToggleTooltips', 'revelioToggleStimulusLinter'].forEach(function(id) {
          var el = document.getElementById(id);
