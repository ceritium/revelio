(function() {
  ...
  function updateMenuButtonState() {
    ...
    if (trigger) {
      if (hasActiveOutlines() || state.showTooltips) {
  ...
  function setupToggles() {
    ...
    if (disableBtn && !disableBtn.hasAttribute('data-temple-devtools-bound')) {
      ...
      disableBtn.addEventListener('click', function() {
        ...
        ['templeToggleViewOutlines', 'templeTogglePartialOutlines', 'templeToggleComponentOutlines', 'templeToggleTooltips'].forEach(function(id) {
          var el = document.getElementById(id);
